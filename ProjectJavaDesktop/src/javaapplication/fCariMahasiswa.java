 ...
 * @author student
 */
public final class fCariMahasiswa extends javax.swing.JFrame {
    ...
    private void jBtnSimpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnSimpanMouseClicked
        // TODO add your handling code here:
        String sql="INSERT into tbl_mahasiswa (nim, nama, semester, alamat,telp, email)VALUE('"+
                    jTxtNIM.getText()+"','"+
                    jTxtNama.getText()+"','"+
    ...
    private void jBtnCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnCariMouseClicked
        ...
        try{ 
            while (rs.next()){ 
                ...
                jTxtSemester.setText(rs.getString("semester").toString()); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fCariMahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fCariMahasiswa().setVisible(true);
            }
        });
    }
