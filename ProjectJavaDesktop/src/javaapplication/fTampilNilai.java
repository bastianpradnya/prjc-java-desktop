 ...
 * @author Arsy25
 */
public class fTampilNilai extends javax.swing.JDialog {

    /**
     * Creates new form fTampilNilai
     */
    public fTampilNilai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                fTampilNilai dialog = new fTampilNilai(new javax.swing.JFrame(), true);
